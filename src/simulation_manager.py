...
class SimulationManager:
    ...
    def _generate_questions(self):
        ...
        try:
            ...
            try:
                ...
                print("Error parsing the generated questions. Using fallback split.")
                self.questions = [q.strip() for q in question_list_str.split('\n') if q.strip()]
        except Exception as e:
            print(f"An error occurred during question generation: {e}")
            self.questions = [] # Ensure questions list is empty on failure
    ...
    def ask_next_question(self, user_response=None):
        ...
        Yields dictionaries for UI updates.
        """
        try:
            if user_response:
    ...
    def _run_performance_analysis(self):
        ...
        try:
            ...
            return f"Could not complete performance analysis due to an error: {e}"
    ...
    def _run_improvement_recommendations(self, performance_summary: str):
        ...
        try:
            ...
            print(f"Error in improvement recommendations: {e}")
    ...
    def _generate_report(self, performance_summary: str, recommendations: str):
        ...
        try:
            ...
            return f"Could not generate the report due to an error: {e}"
    ...
    def _generate_learning_path(self, recommendations: str):
        ...
        try:
            ...
            print(f"Error in generating learning path: {e}")
            return f"Could not generate a learning path due to an error: {e}"
